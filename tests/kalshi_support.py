"""Shared, offline test helpers for the Kalshi adapter tests.

Not collected by pytest (no ``test_`` prefix). Contains a deterministic fake
transport and fixture loader so the suite never touches the network.
"""
...
from prediction_market_arbitrage.adapters.kalshi import HttpResponse
...
@dataclass
class FakeTransport:
    """A :class:`~...kalshi.Transport` that replays canned responses by URL match."""
